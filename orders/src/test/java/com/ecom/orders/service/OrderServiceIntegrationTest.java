...
class OrderServiceIntegrationTest {
    ...
    void updateOrderTotal_shouldUpdateOrder() {
        // On simule récupération commande existante
    ...
    void findByUserIdAndOrderStatus_shouldReturnOrder() {
        ...
        // Vérification, commande retournée ok
    ...
    // 6 : Placement commande avec utilisateur inexistant
    @Test
    void placeOrder_shouldReturnNull_whenUserNotFound() throws Exception {
        ...
        // Vérification, null car utilisateur introuvable
        assertNull(result);
    }

    // 7 : Placement commande avec échec génération QR code
    @Test
    ...
    void getMyPlacedOrders_shouldReturnList() {
        ...
        // Vérification, liste retournée avec commande ok
